# Generated by Django 4.1.4 on 2023-03-03 13:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('media', '0016_media_favorited_delete_evaluation'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='groups',
            field=models.ManyToManyField(related_name='user_group_set', to='auth.group'),
        ),
        migrations.AddField(
            model_name='user',
            name='is_active',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='user_permission_set', to='auth.permission'),
        ),
        migrations.AddField(
            model_name='user',
            name='username',
